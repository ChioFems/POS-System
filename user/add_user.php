					...
					<table class="table-responsive mt-5">
						...
						<tbody>
							...
							<tr>
								...
								<td class="pl-5 pb-2"><div class="input-group"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-phone"></i></span></div><input type="tel" name="number" title='Phone Number (Format: 0688998899)' class="form-control form-control-sm" placeholder="Enter Contact number" required></div></td>
								////name="number" pattern='[\+]\d{3}[\(]\d{1}[\)]\d{3}[\-]\d{6}' title='Phone Number (Format: +255(0)689-998899)' class="form-control form-control-sm" placeholder="Enter Contact number" required></div></td>
							</tr>
							<tr>
